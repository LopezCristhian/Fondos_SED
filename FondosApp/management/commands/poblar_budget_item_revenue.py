...
from FondosApp.models import BudgetItemRevenue

class Command(BaseCommand):
    help = 'Importación de rubros presupuestales de ingresos desde archivo CSV local'  
    
    def add_arguments(self, parser):
        parser.add_argument(
            '--file',
            type=str,
            default='data/budget_item_revenue_data.csv',
        ...
        try:
            ...
            for index, row in df.iterrows():
                try:
                    ...
                    # Crear registro
                    obj, created = BudgetItemRevenue.objects.get_or_create(
                        code=code,
                        defaults=defaults
                    )
