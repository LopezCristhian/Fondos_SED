"""
Django settings for Fondos_SED project.
...
SECRET_KEY = 'django-insecure-qv-khowimvkxayumwump*%ao1!u%ts8cv31c1zygj7isc=7tnp'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'fondos_sed'),
